    ...
    return (
        <div className={`px-4 lg:col-span-4`}>
            <div className={styles.showcaseCopyContainer}>
                ...
                <div className={`text-lg my-8 w-fit md:text-2xl md:text-left xl:w-3/4`}>The Sound is your source for curated live music in Rochester, NY and a music community incubator initiative.</div>
                <SubmitShowCTA />
            </div>
        </div>
    );
